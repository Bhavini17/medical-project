...
<html lang="en">
  ...
  <div id="pm_theme_color_selector">
	...
	<div id="pm_layout_wrapper" class="pm-full-mode"><!-- Use wrapper for wide or boxed mode -->
                ...
                <div class="container">
                	<div class="row">
                    	<div class="col-lg-12">
                            ...
                            <p class="pm-page-title">gel seat</p>
                            <p class="pm-page-message">As comfortable as it looks!</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 pm-column-spacing">
                            ...
                            <ul class="pm-woocomm-item-thumbs">
                            	<li><a href="#"><span></span><i class="fa fa-expand"></i></a><img src="img/store/thumb1.jpg" class="img-responsive" width="180" height="148" alt="Thumbnail"></li>
                                <li><a href="#"><span></span><i class="fa fa-expand"></i></a><img src="img/store/thumb2.jpg" class="img-responsive" width="180" height="148" alt="Thumbnail"></li>
                                <li><a href="#"><span></span><i class="fa fa-expand"></i></a><img src="img/store/thumb3.jpg" class="img-responsive" width="180" height="148" alt="Thumbnail"></li>
                            </ul>
                            
                        </div>
                        
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <p class="pm-woocom-item-title">Gel Seat</p>
                            ...
                            <p class="pm-woocom-item-price">$49.99</p>
                            ...
                            <div class="pm-woocom-tags-container">
                                ...
                                <div class="product_meta">
                                    ...
                                    <span class="posted_in"> Collection: <a rel="tag" href="#">Cushion</a>, <a rel="tag" href="#">seats</a> </span>
                                    <span class="tagged_as"> Tagged in: <a rel="tag" href="#">comfort</a></span>
        ...
        <!-- PANEL 2 -->
        <div class="pm-column-container pm-parallax-panel" style="background-color:#20bac7; background-image:url(img/product-post/description-bg.jpg);" data-stellar-background-ratio="0.5">
                                ...
                                <div id="pm-product-comments">
                                    <h3>Posted Reviews</h3>
                                        ...
                                        <ol class="commentlist">
                                            <li id="li-comment-15" class="comment byuser comment-author-pmedia bypostauthor even thread-even depth-1">
                            
                                                <div class="comment_container" id="comment-15">
                                                    <img width="60" height="60" class="avatar avatar-60 photo" src="img/product-post/01_avatar.jpg" alt="pmedia">
                                                    <div class="comment-text">
                                                                        
                                                            <p class="meta">
                                                                <strong>Joe Bonucci</strong> &ndash; <time datetime="2014-08-05T21:44:42+00:00">August 5, 2014</time>
                                                            </p>
                                                        
                                                        <div class="description"><p>What a product! I highly recommended this to anyone.</p></div>
                                                    </div>
                                                </div>
                                            </li><!-- #comment-## -->
                                        </ol>
                                    ...
                                    <div id="review_form_wrapper">
                                        <div id="review_form">
                                            ...
                                            <form class="comment-form" id="commentform" method="post" action="http://wp.pulsarmedia.ca/quantum/wp-comments-post.php">
                                            <p class="comment-form-author">
                                            
                                            <input type="text" aria-required="true" size="30" value="" name="author" id="author" class="pm-textfield review-field" placeholder="Name">
                                            </p>
                                            <p class="comment-form-email">
                                            
                                            <input type="text" aria-required="true" size="30" value="" name="email" id="email" class="pm-textfield review-field" placeholder="Email Address">
                                            </p>
                                            <p class="comment-form-comment">
                                            <textarea aria-required="true" rows="8" cols="45" name="comment" id="comment" class="pm-textarea review-field placeholder" placeholder="Comment…" required></textarea>
                                            </p>
                                            <p class="form-submit">
                                            <input type="submit" value="Submit Review" id="submit" name="submit" class="pm-review-submit-btn">
        ...
        <div class="container pm-containerPadding-top-100 pm-containerPadding-bottom-80">
        	...
        	<div class="row">
            	...
            	<div class="col-lg-12 pm-column-spacing">
                	<h4 class="pm-primary">Related Products</h4>
                </div>
            ...
            <div class="row">
            	...
            	<div class="col-lg-4 col-md-4 col-sm-6 pm-column-spacing">
                    ...
                    <!-- Product 1 -->
                    <a href="product-post.html" class="pm-store-post-title">Airgo&reg; Two Touch Folding Walker</a>
                    ...
                    <div class="pm-store-post-container">
                        ...
                        <div class="pm-store-post-info-container">
                        	...
                        	<div class="pm-store-post-info-overlay">
                            	<p class="pm-store-post-quantity">87 in stock</p>
                                <p class="pm-store-post-excerpt">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque eu porta elit, in pulvinar elit. <a href="#">[...]</a></p>
                                <a href="product-post.html" class="pm-store-post-details-btn fa fa-bars"></a>
                                <a href="#" class="pm-store-post-details-btn pm-close-btn fa fa-close"></a>
                            </div>
                        
                        	<div class="pm-store-post-img">
                       	    	<img src="img/store/post3.jpg" class="img-responsive" alt="Airgo Two Touch Folding Walker">
                            </div>
                            
                            <div class="pm-store-post-tags">
                            	<a href="#" class="fa fa-chevron-up pm-store-post-expander"></a>
                            	<p>collection: <a href="#">aid</a>, <a href="#">personal care</a></p>
                                
                            </div>
                        
                      </div>
                        
                      <a href="#" class="pm-add-to-cart-btn pm-rounded-btn small">Add to Cart</a>
                        
                    </div>
                    
                    <p class="pm-store-post-price">$69.99</p>
                    <!-- Product 1 end -->
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 pm-column-spacing">
                    ...
                    <!-- Product 2 -->
                    <a href="product-post.html" class="pm-store-post-title">Personal Fitness Care Kit</a>
                    ...
                    <div class="pm-store-post-container">
                        ...
                        <div class="pm-store-post-info-container">
                        	...
                        	<div class="pm-store-post-info-overlay">
                            	<p class="pm-store-post-quantity">33 in stock</p>
                                <p class="pm-store-post-excerpt">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque eu porta elit, in pulvinar elit. <a href="#">[...]</a></p>
                                <a href="product-post.html" class="pm-store-post-details-btn fa fa-bars"></a>
                                <a href="#" class="pm-store-post-details-btn pm-close-btn fa fa-close"></a>
                            </div>
                        	...
                        	<div class="pm-store-post-img">
                       	    	<img src="img/store/post6.jpg" class="img-responsive" alt="Personal Fitness Care Kit">
                            </div>
                            
                            <div class="pm-store-post-tags">
                            	<a href="#" class="fa fa-chevron-up pm-store-post-expander"></a>
                            	<p>collection: <a href="#">kits</a>, <a href="#">fitness</a></p>
                    ...
                    <p class="pm-store-post-price">$89.99</p>
                    <!-- Product 2 end -->
            	...
            	<div class="col-lg-4 col-md-4 col-sm-6 pm-column-spacing">
                    ...
                    <!-- Product 3 -->
                    <a href="product-post.html" class="pm-store-post-title">Sphygmomanometer System</a>
                    ...
                    <div class="pm-store-post-container">
                        ...
                        <div class="pm-store-post-info-container">
                        	...
                        	<div class="pm-store-post-info-overlay">
                            	<p class="pm-store-post-quantity">92 in stock</p>
                                <p class="pm-store-post-excerpt">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque eu porta elit, in pulvinar elit. <a href="#">[...]</a></p>
                                <a href="product-post.html" class="pm-store-post-details-btn fa fa-bars"></a>
                                <a href="#" class="pm-store-post-details-btn pm-close-btn fa fa-close"></a>
                            </div>
                        	...
                        	<div class="pm-store-post-img">
                       	    	<img src="img/store/post7.jpg" class="img-responsive" alt="Sphygmomanometer System">
                            </div>
                            
                            <div class="pm-store-post-tags">
                            	<a href="#" class="fa fa-chevron-up pm-store-post-expander"></a>
                            	<p>collection: <a href="#">personal care</a></p>
                    ...
                    <p class="pm-store-post-price">$49.99</p>
                    <!-- Product 3 end -->
