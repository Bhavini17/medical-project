                        ...
                        <nav class="navbar-collapse collapse" id="pm-main-navigation">
                            ...
                            <ul class="sf-menu pm-nav">
                                ...
                                <li>
                                    ...
                                    <ul>
                                        <li><a href="{{URL:: asset('medical-staff')}}">Blog Page</a></li>
                ...
                <div class="container">
                	<div class="row">
                    	<div class="col-lg-12">
                            ...
                            <p class="pm-page-title">Cart</p>
                            <p class="pm-page-message">Ready to checkout?</p>
                    ...
                    <div class="pm-cart-info-container">
                        ...
                        <div class="row">
                        	...
                        	<div class="col-lg-2 col-md-2 col-sm-2 pm-cart-info-column">
                       	    	<img src="img/store/item1.jpg" width="50" height="50" alt="Gel Seat"> 
                            </div>
                            
                            <div class="col-lg-2 col-md-2 col-sm-2 pm-cart-info-column text">
                            	<a href="{{URL:: asset('prod-post')}}">Gel Seat</a>
                            </div>
                            ...
                            <div class="col-lg-2 col-md-2 col-sm-2 pm-cart-info-column quantity">
                            	<div class="quantity buttons_added pm-checkout-quantity">
                                    <input type="number" class="input-text qty cart text" title="Qty" value="1" name="quantity" min="1" step="1" >
                            ...
                            <div class="col-lg-2 col-md-2 col-sm-2 pm-cart-info-column">
                            	<a href="#" class="pm-square-btn pm-cart-remove">Remove</a>
                            </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 pm-column-spacing">
                    ...
                    <div class="pm-cart-shipping-calculator">
                      ...
                      <div class="pm-cart-shipping-calculator-fields">
                            ...
                            <input name="" type="text" placeholder="Postal/Zip" class="pm-woocomm-textfield" style="margin-bottom:15px;">
                            <input type="submit" value="Calculate" class="pm-woocomm-submit-btn" style="margin-bottom:0px;" />
                        </div>
                ...
                <div class="col-lg-8 col-md-8 col-sm-8">
                    ...
                    <div class="pm-cart-totals">
                        ...
                        <div class="pm-cart-totals-buttons">
                        	<input type="submit" value="Update Cart" class="pm-woocomm-submit-btn" style="margin-bottom:0px;" />
                            <a href="{{URL:: asset('checkout')}}" class="pm-woocomm-submit-btn" style="margin-bottom:0px;">Checkout</a>
                        </div>
